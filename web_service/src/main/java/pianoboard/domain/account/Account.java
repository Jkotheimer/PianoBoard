...
public class Account {
	...
	private Map<String, int> failedLoginAttempts;
	...
	public Account(String ID, String username, String Password, long creationDate) {
		...
		this.failedLoginAttempts = new HashMap<String, int>();
	}
	...
	public Map<String, int> getFailedLoginAttempts()	{ return this.failedLoginAttempts;	}
	...
	public void setFailedLoginAttempts(Map<String, int> f)	{ this.failedLoginAttempts = f;			}
	...
	public boolean login(String username, String password, String IP, long timestamp) {
